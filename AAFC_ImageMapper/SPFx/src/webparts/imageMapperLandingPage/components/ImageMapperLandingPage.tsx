...
import type { IImageMapperLandingPageProps } from './IImageMapperLandingPageProps';
  ...
  public render(): React.ReactElement<IImageMapperLandingPageProps> {
    return (
      ...
      >
        ...
        >
          <image xlinkHref={this.props.imageUrl} />
            ...
            if (imageMapping.imapType === "Path") {
              return (
                <a
                  ...
                  onClick={() =>
                    this.onClick(imageMapping.url ?? "",  imageMapping.openInNewWindow ?? false)
                  }
                >
                  <path d={imageMapping.d} fill="#fff" opacity="0" />
                </a>
              );
            } else {
              return (
