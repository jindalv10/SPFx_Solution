...
export class Fields
{
    ...
    static readonly AnswersFr= 'AnswersFr';
    static readonly Explanations= 'Explanations';
    static readonly ExplanationsFr= 'ExplanationsFr';
    static readonly IsFeaturedQuiz= 'IsFeaturedQuiz';
...
{
    static readonly QuizQuestions = 'QuizQuestions'
}